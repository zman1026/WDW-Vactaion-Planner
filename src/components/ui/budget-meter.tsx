...
export function BudgetMeter({ plannedCents, budgetCents, paidExtrasCents = 0, compact = false }: { plannedCents: number; budgetCents: number | null; paidExtrasCents?: number; compact?: boolean }) {
