...
export const controlStyles = "w-full rounded-control border border-border bg-surface px-3.5 py-2.5 text-sm text-ink shadow-sm outline-none transition placeholder:text-muted/60 focus:border-gold focus:ring-4 focus:ring-gold/15 disabled:bg-parchment disabled:text-muted";
