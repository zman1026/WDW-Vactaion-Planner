...
export function TripForm() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const payload = { name: String(form.get("name") ?? ""), startDate: String(form.get("startDate") ?? ""), endDate: String(form.get("endDate") ?? ""), budget: String(form.get("budget") ?? ""), notes: String(form.get("notes") ?? "") };
